...
<head>
  ...
  <title>Aplikasi Toko 0029</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="card">
        ...
        <div class="card-body">
          <h4 class="text-center  mt-5">Selamat datang di aplikasi penjualan</h4>
        </div>
        <!-- /.card-body -->
        <!-- /.card-footer-->
      </div>
  ...
  <footer class="main-footer">
    ...
    <strong>&copy; 2024 <a href="#">AURA SALSABILA 0029</a>.</strong> All rights reserved.
  </footer>
