...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">TOKO AURA 0029</span>
    </a>
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="index.php?page=edit_brg&id_barang=<?= $item['id_barang'] ?>" class="btn btn-warning btn-sm">Edit</a> |
                        <a href="index.php?page=delete_barang&id_barang=<?= $item['id_barang'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus transaksi ini?')">Hapus</a>
                    </td>
                </tr>
                <?php
                    }
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2024  <a href="#">AURA SALSABILA 0029</a>.</strong> All rights reserved.
  </footer>
